...
function rectangleOffsetX(rectangle, num3){
    rectangle.upperLeftPoint.x1 += num3;
    rectangle.lowerRightPoint.x2 += num3;
}
rectangleOffsetX(rectangle, 7);
console.log(`После смещения прямоугольника по оси Х координата х1 стали равны:${rectangle.upperLeftPoint.x1}`);
console.log(`После смещения прямоугольника по оси Х координата х2 стали равны: ${rectangle.lowerRightPoint.x2}`);
console.log('*****')
//Задача 1.10. Функция смещения прямоугольника по оси Y. Она принимает объект-прямоугольник и на сколько единиц его сдвинуть.
function rectangleOffsetY(rectangle, num4){
    rectangle.upperLeftPoint.у1 += num4;
    rectangle.lowerRightPoint.у2 += num4;
}
rectangleOffsetY(rectangle, 10);
console.log(`После смещения прямоугольника по оси У координата у1 стали равны:${rectangle.upperLeftPoint.у1}`);
console.log(`После смещения прямоугольника по оси У координата у2 стали равны: ${rectangle.lowerRightPoint.у2}`);
console.log('*****')
