...
export default function App() {
    ...
    function addNewTask(event) {
        ...
        const newTasks = [
            ...tasks,
            {id: uid(), date: date, text: text, price: price} 
        ];
    ...
    <>
        ...
        <H1 headerText={"Expenses"} />
        <form action="from" onSubmit={addNewTask}>
            <input type="date" placeholder="Дата совершения расхода..." value={text} onChange={ (e) => setText(e.target.value) } />
            <input type="text" placeholder="Описание расхода..." value={} onChange={ (e) => setText(e.target.value) } /> 
            <input type="number" placeholder="Цена расходной операции..." value={text} onChange={ (e) => setText(e.target.value) } /> 
